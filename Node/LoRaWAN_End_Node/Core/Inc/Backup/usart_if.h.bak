 ...
 */
void SYS_GetNPK(uint16_t*, uint16_t*, uint16_t*);
/**
 * @brief Get the current NPK sensor Nitrogen levels
 * @return return raw Nitrogen reading.
 */
uint16_t SYS_GetN(void);
/**
 * @brief Get the current NPK sensor Phosphorous levels
 * @return return raw Phosphorus reading.
 */
uint16_t SYS_GetP(void);
/**
 * @brief Get the current NPK sensor Potassium levels
 * @return return raw Potassium reading.
 */
