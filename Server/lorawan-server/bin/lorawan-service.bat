...
%ERLSRV% add "LoRaWAN Server" -w "%ROOT_DIR%" -sname lorawan -ar "+Bd -pa !FILES! -s lorawan_app -config releases\0.6.7\sys.config" -c "Handles packets received by LoRaWAN gateways"
goto END
